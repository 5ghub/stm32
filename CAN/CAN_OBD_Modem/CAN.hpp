...
typedef enum {CAN_50KBPS = 0, CAN_100KBPS, CAN_125KBPS, CAN_250KBPS, CAN_500KBPS, CAN_1000KBPS} BITRATE;
...
void CANSend(CAN_msg_t* CAN_tx_msg)
{
  ...
  printRegister("CAN->ESR=", CAN->ESR);
  printRegister("CAN->MSR=", CAN->MSR);
  printRegister("CAN->TSR=", CAN->TSR);   
}
...
void SendOBDMessage(uint8_t Service, uint8_t Code)
{
  ...
  CAN_tx_msg.data[1] = Service;
  CAN_tx_msg.data[2] = Code;
